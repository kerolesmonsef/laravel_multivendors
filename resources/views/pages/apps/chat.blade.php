          ...
          <div class="col-lg-4 chat-aside border-lg-left">
            <div class="aside-content">
                ...
                <div class="d-flex justify-content-between align-items-center pb-2 mb-2">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                      <a class="dropdown-item d-flex align-items-center" href="#"><i data-feather="eye" class="icon-sm ml-2"></i> <span class="">View Profile</span></a>
                      <a class="dropdown-item d-flex align-items-center" href="#"><i data-feather="edit-2" class="icon-sm ml-2"></i> <span class="">Edit Profile</span></a>
                      <a class="dropdown-item d-flex align-items-center" href="#"><i data-feather="aperture" class="icon-sm ml-2"></i> <span class="">Add status</span></a>
                      <a class="dropdown-item d-flex align-items-center" href="#"><i data-feather="settings" class="icon-sm ml-2"></i> <span class="">Settings</span></a>
                    </div>
                  </div>
                </div>
              ...
              <div class="aside-body">
                <ul class="nav nav-tabs mt-3 pr-0" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="chats-tab" data-toggle="tab" href="#chats" role="tab" aria-controls="chats" aria-selected="true">
                      <div class="d-flex flex-row flex-lg-column flex-xl-row align-items-center">
                        <i data-feather="message-square" class="icon-sm ml-sm-2 ml-lg-0 ml-xl-2 mb-md-1 mb-xl-0"></i>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="calls-tab" data-toggle="tab" href="#calls" role="tab" aria-controls="calls" aria-selected="false">
                      <div class="d-flex flex-row flex-lg-column flex-xl-row align-items-center">
                        <i data-feather="phone-call" class="icon-sm ml-sm-2 ml-lg-0 ml-xl-2 mb-md-1 mb-xl-0"></i>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="contacts-tab" data-toggle="tab" href="#contacts" role="tab" aria-controls="contacts" aria-selected="false">
                      <div class="d-flex flex-row flex-lg-column flex-xl-row align-items-center">
                        <i data-feather="users" class="icon-sm ml-sm-2 ml-lg-0 ml-xl-2 mb-md-1 mb-xl-0"></i>
                          ...
                          <a href="javascript:;" class="d-flex align-items-center">
                            ...
                            <div class="d-flex justify-content-between flex-grow border-bottom">
                              ...
                              <div class="d-flex flex-column align-items-end">
                                ...
                                <div class="badge badge-pill badge-primary mr-auto">5</div>
                              </div>
                            </div>
                          </a>
                        </li>
                            ...
                            <div class="d-flex justify-content-between flex-grow border-bottom">
                              <div>
                                ...
                                <div class="d-flex align-items-center">
                                  ...
                                  <p class="text-muted mr-1">Photo</p>
                                </div>
                              </div>
                              <div class="d-flex flex-column align-items-end">
                                <p class="text-muted tx-13 mb-1">05:24 PM</p>
                                <div class="badge badge-pill badge-danger mr-auto">3</div>
                              </div>
                            </div>
                          </a>
                        </li>
                            ...
                            <div class="d-flex justify-content-between flex-grow border-bottom">
                              <div>
                                ...
                                <div class="d-flex align-items-center">
                                  ...
                                  <p class="text-muted mr-1">Video</p>
                                </div>
                              </div>
                              <div class="d-flex flex-column align-items-end">
                        ...
                        <a href="javascript:;" class="d-flex align-items-center">
                          ...
                          <div class="d-flex align-items-center justify-content-between flex-grow border-bottom">
                            <div>
                              <p class="text-body">Jensen Combs</p>
                              <div class="d-flex align-items-center">
                                <i data-feather="arrow-up-right" class="icon-sm text-success ml-1"></i>
                        ...
                        <a href="javascript:;" class="d-flex align-items-center">
                          ...
                          <div class="d-flex align-items-center justify-content-between flex-grow border-bottom">
                            <div>
                              <p class="text-body">Leonardo Payne</p>
                              <div class="d-flex align-items-center">
                                <i data-feather="arrow-down-left" class="icon-sm text-success ml-1"></i>
                        ...
                        <a href="javascript:;" class="d-flex align-items-center">
                          ...
                          <div class="d-flex align-items-center justify-content-between flex-grow border-bottom">
                            <div>
                              ...
                              <div class="d-flex align-items-center">
                                <i data-feather="arrow-down-left" class="icon-sm text-danger ml-1"></i>
                        ...
                        <a href="javascript:;" class="d-flex align-items-center">
                          ...
                          <div class="d-flex align-items-center justify-content-between flex-grow border-bottom">
                            ...
                            <div class="d-flex align-items-end text-body">
                              <i data-feather="message-square" class="icon-md text-success ml-2"></i>
                              <i data-feather="phone-call" class="icon-md text-primary ml-2"></i>
          ...
          <div class="col-lg-8 chat-content">
            <div class="chat-header border-bottom pb-2">
              <div class="d-flex justify-content-between">
                <div class="d-flex align-items-center">
                  <i data-feather="corner-up-left" id="backToChatList" class="icon-lg ml-2 mr-n2 text-muted d-lg-none"></i>
                  <figure class="mb-0 ml-2">
                ...
                <div class="d-flex align-items-center mr-n1">
                  <a href="#">
                    <i data-feather="video" class="icon-lg text-muted ml-3" data-toggle="tooltip" title="Start video call"></i>
                  </a>
                  <a href="#">
                    <i data-feather="phone-call" class="icon-lg text-muted mr-0 ml-sm-3" data-toggle="tooltip" title="Start voice call"></i>
                  </a>
            ...
            <div class="chat-footer d-flex">
              <div>
                <button type="button" class="btn border btn-icon rounded-circle ml-2" data-toggle="tooltip" title="Emoji">
                  <i data-feather="smile" class="text-muted"></i>
                </button>
              </div>
              <div class="d-none d-md-block">
                <button type="button" class="btn border btn-icon rounded-circle ml-2" data-toggle="tooltip" title="Attatch files">
                  <i data-feather="paperclip" class="text-muted"></i>
                </button>
              </div>
              <div class="d-none d-md-block">
                <button type="button" class="btn border btn-icon rounded-circle ml-2" data-toggle="tooltip" title="Record you voice">
                  <i data-feather="mic" class="text-muted"></i>
                </button>
              </div>
              <form class="search-form flex-grow ml-2">
