              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center mb-2">
                    <i data-feather="check" class="icon-md text-primary ml-2"></i>
                  ...
                  <div class="d-flex align-items-center mb-2">
                    <i data-feather="x" class="icon-md text-light ml-2"></i>
            ...
            <div class="col-md-4 stretch-card grid-margin grid-margin-md-0">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center mb-2">
                    <i data-feather="check" class="icon-md text-danger ml-2"></i>
                    <p>Accounting dashboard</p>
                  </div>
                  <div class="d-flex align-items-center mb-2">
                    <i data-feather="check" class="icon-md text-danger ml-2"></i>
