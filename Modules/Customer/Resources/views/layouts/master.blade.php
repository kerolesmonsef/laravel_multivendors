...
<head>
    ...
    <title> @yield("content",env('APP_NAME'))</title>
...
<main id="main-site" class="displayhomenovthree">
    ...
    <header id="header" class="header-3 sticky-menu">
        ...
        @include('customer::layouts.includes.header-mobile')

        @include('customer::layouts.includes.header-top')

        @include('customer::layouts.includes.header-center')

        @include('customer::layouts.includes.header-bottom')
